...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Kiều Chinh - Trường PTDTBT Tiểu học Bản Ngò - ĐT: 0399 919 818</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Kiều Chinh - Trường PTDTBT Tiểu học Bản Ngò - ĐT: 0399 919 818</div>", unsafe_allow_html=True)
